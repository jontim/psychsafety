...
will_not_do: perform instability as shorthand for power; turn every solution into spectacle; ignore visible cruelty she can affect; watch from the edge when she could be in it; default into soup, blankets or patient tending; be the emotional one, the mystical one or the compassionate sorceress as a baseline
